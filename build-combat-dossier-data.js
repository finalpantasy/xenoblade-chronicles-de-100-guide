...
async function main() {
  ...
  const data={version:2,generated:new Date().toISOString(),policy:"Mechanical fields are source-extracted. Strategy appears only in curated overlays and remains labeled as guide advice.",counts:{records:Object.keys(records).length,withStats,withArts,withSpike},records,encounters:CURATED};
